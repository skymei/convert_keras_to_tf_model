...
class AndroidConvertMultiService(object):

    @classmethod
    def convert_multi_android_model(cls, local_model_path):
        # start to convert
        keras.backend.clear_session()
        keras.backend.set_learning_phase(0)
        MultiStyleTransferNetwork.build(
            (256, 256),
            13,
            alpha=0.5,
...
AndroidConvertMultiService.convert_multi_android_model('model_path')
